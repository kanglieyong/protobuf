...
const {get32BitVarintLength, getGroupTagLength} = goog.require('protobuf.binary.tag');
...
function doReadGroup(
  ...
  const groupTagLength = get32BitVarintLength(fieldNumber << 3);
  const groupLength = getGroupTagLength(bufferDecoder, fieldStartIndex);
